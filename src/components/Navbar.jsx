      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-4 text-sm font-medium">
          {!isLoggedIn ? (
            ...
            <>
              {userRole === 'admin' && (
                <Link to="/admin" className="px-4 py-2 bg-gray-900 border border-emerald-500 text-emerald-500 hover:text-white hover:bg-emerald-700 rounded-lg transition duration-200 shadow-sm">
                  Admin
                </Link>
              )}
